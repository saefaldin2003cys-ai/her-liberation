...
var rightsData = {
    9: {
        legalCapacity: {
            ...
            lawLink: 'https://iraqld.hjc.iq/LoadLawBook.aspx?SC=050120099264628'
        },
        economicRights: {
            status: 'forbidden',
...
function showDetails(key, age) {
    ...
    var viewLawLabel = window.i18n ? window.i18n.t('rights.view_law', 'عرض القانون') : 'عرض القانون';

    var lawLinkHtml = '';
    if (right.lawLink) {
        lawLinkHtml = '<a href="' + right.lawLink + '" target="_blank" class="law-link-btn">📖 ' + viewLawLabel + '</a>';
    }
